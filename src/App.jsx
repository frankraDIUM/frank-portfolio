...
const projects = [
  ...
  },
  {
    category: "GeoAI",
    index: "03",
    title: "Cape Town Urban Change Detection & Compliance Monitoring System",
    subtitle: "Human-in-the-Loop Unauthorized Development Detection",
    description:
      "A Human-in-the-Loop GeoAI tool for detecting unauthorized urban development in Khayelitsha, Cape Town. Combines Sentinel-2 satellite imagery, official Cape Town GIS layers, change detection, rule-based compliance, and machine learning to help urban planners identify and prioritize potential land-use violations.",
    highlights: ["Change detection", "Compliance monitoring", "Human-in-the-Loop GeoAI"],
    github: "https://github.com/frankraDIUM/Cape-Town-Urban-Change-Detection-Compliance-Monitoring-System",
    accent: "#00D4B4",
  },
  {
    category: "GeoAI",
  ...
  },
  {
    ...
    description:
      "Automated, end-to-end GIS and machine-learning pipeline to analyze the risk of water point infrastructure across Kenya, with a focused application in Nairobi. Combines spatial data ingestion, feature engineering, and predictive risk scoring.",
    highlights: ["GIS-ML pipeline", "Infrastructure risk scoring", "Nairobi application"],
    github: "https://github.com/frankraDIUM/Automated-GIS-ML-System-for-Water-Infrastructure-Risk-in-Kenya",
    accent: "#7B61FF",
  },
  {
    category: "Spatial Data Science",
  ...
  },
  {
    ...
    description:
      "Predicts customer attrition for a telecommunications company using machine learning and Explainable AI (SHAP) to identify high-risk customers and uncover the specific service and contractual factors driving their departure.",
    highlights: ["XGBoost / ML", "SHAP explainability", "Churn risk scoring"],
    github: "https://github.com/frankraDIUM/Telco-Customer-Churn-Predictive-Analysis-Explainable-AI",
    accent: "#FF6B6B",
  },
  {
    category: "Machine Learning",
          ...
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
            ...
            <div>
              ...
              <p className="hero-animate-3" style={{
                ...
                Data Analyst and GeoAI practitioner transforming complex geospatial, business, and machine learning data into intelligent systems, predictive insights, and impactful visual experiences.
              </p>
